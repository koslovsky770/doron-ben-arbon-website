  ...
  return (
    <section className="relative overflow-hidden bg-ink-13 lg:flex lg:items-stretch">
      ...
      {/* image column — left on desktop, stacked on top for mobile.
          Flex (not absolute) so widening it can never overlap the text column:
          the text side is flex-1 and simply gets whatever space is left. */}
      <div className="relative h-[380px] w-full overflow-hidden sm:h-[460px] lg:h-auto lg:w-[min(calc(50%+400px),78%)] lg:shrink-0">
        <img
          src="/images/hero.jpg"
