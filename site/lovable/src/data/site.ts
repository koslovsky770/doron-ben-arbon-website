...
export const hero = {
  ...
  titleEnd: "?",
  subtitle: "העסק שלך צריך את הנכס הנכון, ואתה צריך מלווה שיילחם בשבילך על החוזה.",
  paragraph:
    "דורון בן ארבון — תשע שנים של תיווך מסחרי, שיווק פרויקטים ומגרשים בבני ברק. בס״ד ביצענו עשרות עסקאות מכירה והשכרה של נכסים ותיווך עסקים, בליווי אישי מלא ובאמינות שלא מתפשרת.",
...
export const about = {
  titleStart: "בונים",
  titleEnd: "אמון,",
  titleSecondLine: "לא רק עסקאות.",
  paragraph:
    "מתוך היכרות עם כל מטר רבוע בבני ברק, וביושר שלא מתפשר — נבטל עסקה בכל שלב אם משהו לא מרגיש נכון עבורכם. זו הסיבה שלקוחות חוזרים שוב ושוב גם לעסקאות הבאות.",
  cta: { label: "קצת עלינו…", href: "/about" },
  stats: [
    { value: "9", label: "שנות ניסיון בבני ברק" },
    { value: "עשרות", label: "עסקאות מכירה והשכרה" },
    { value: "מלא", label: "ליווי עד קבלת המפתח" },
  ],
...
export const servicesSection = {
  title: "השירות שתקבלו",
  paragraph:
    "שלושה תחומי פעילות, גישה אחת: בקיאות חסרת פשרות בשטח, יושר לפני הכל, וליווי אישי עד לקבלת המפתח.",
  items: [
    {
      id: "commercial",
      title: "תיווך מסחרי",
    ...
    },
    {
      ...
      title: "מגרשים",
      description:
        "איתור ותיווך מגרשים לבנייה ולהשקעה, עם היכרות מלאה עם השטח והזדמנויות שלא מגיעות ללוחות.",
...
export const googleReviewsSection = {
  title: "מה כתבו עלינו בגוגל",
  paragraph:
    "כל הביקורות למטה נכתבו על ידי לקוחות אמיתיים בכרטיס העסקי של המשרד בגוגל.",
  allReviewsLabel: "לכל הביקורות בגוגל",
};

export const testimonialsSection = {
  title: "ומה שכתבו לקוחות עסקיים",
  paragraph:
    "יזמים, חברות הנדסה ומשרדי נכסים שליווינו — מתוך הפרוספקט הרשמי.",
  items: [
    {
      id: "greenblatt",
      quote:
